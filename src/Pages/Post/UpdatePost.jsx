        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <form className="space-y-4">
            ...
            <Button 
              ...
              onClick={showModal} 
              disabled={loading} 
              className={`w-full py-3 px-6 font-semibold rounded-lg shadow-md text-md text-white ${loading ? 'bg-gray-500' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}>
